...
abstract class HomeRepository {
  ...
  Future<Either<String, PartnersResponse>> getPartners();
}
...
class HomeRepositoryImpl extends HomeRepository {
  ...
  @override
  Future<Either<String, PartnersResponse>> getPartners() async {
    try {
      LocalizationCacheHelper localizationCacheHelper =
          LocalizationCacheHelper();
      final response = await _networkService.get(
        "partners?lang=${localizationCacheHelper.getLanguageCode()}",
      );
      PartnersResponse res = PartnersResponse.fromJson(response.data);
      return Right(res);
    } catch (e, t) {
      debugPrint("error:$e-- trace $t");
      return Left(e.toString());
