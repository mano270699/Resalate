...
class UserMasjidItem extends StatefulWidget {
  ...
  @override
  State<UserMasjidItem> createState() => _UserMasjidItemState();
}

class _UserMasjidItemState extends State<UserMasjidItem> {
  double? _distanceKm;
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        "${widget.masjid.name}gifuyffuttu",
                      ...
                      BlocConsumer<GenericCubit<FollowMasjedResponse>,
                        ...
                        listener: (context, state) {
                          if (state is GenericUpdatedState &&
                              state.data.masjidId == widget.masjid.id) {
                            ...
                            // Re-fetch user masjeds list
                            sl<MasjedViewModel>().getUserMasjeds();
                        ...
                        builder: (context, actionState) {
                          bool isFollowing = widget.masjid.isFollowing;
                          if (actionState is GenericUpdatedState &&
                            ...
                            widget.masjid.isFollowing = isFollowing;
                          }

                          return InkWell(
                            onTap: () {
                              setState(() => _isLoading = true);
                              final vm = sl<MasjedViewModel>();
                              if (isFollowing) {
                                vm.unfollowMasjed(context,
                                    masjedId: widget.masjid.id ?? 0);
                              } else {
                                vm.followMasjed(context,
                                    masjedId: widget.masjid.id ?? 0);
                              }
                            },
                            child: Container(
                  ...
                  Text(
                    [
                      widget.masjid.city,
                      widget.masjid.province,
                      widget.masjid.country
