...
class AppColors {
  static const Color primaryColor = Color(0xFF048e74);
  static const Color scondaryColor = Color(0xFF234572);
  ...
  static const Color otpBorder = Color(0xFFDFDFDF);
  static const Color darkBlack = Color(0xFF0D101C);
