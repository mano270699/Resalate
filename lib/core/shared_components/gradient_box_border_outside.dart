...
class GradientBoxBorderOutSide extends BoxBorder {
  final Gradient gradient;
  final double width;

  const GradientBoxBorderOutSide({required this.gradient, this.width = 1.0});
  ...
  void _paintRRect(Canvas canvas, Rect rect, BorderRadius borderRadius) {
    final RRect rrect = borderRadius.toRRect(rect).inflate(width / 2.0);
